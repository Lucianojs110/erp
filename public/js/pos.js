    ...
    $('#search_product')
        .autocomplete({
            ...
            open: function () {
                ...
                var availableHeight = $(window).height() - menuTop - 20;

                $menu.css({
                    'max-height': Math.max(150, availableHeight) + 'px',
                    'overflow-y': 'auto',
                    'overflow-x': 'hidden',
                    'z-index': 99999,
                });
            ...
            response: function (event, ui) {
                var inicio = globalThis.term1.substring(0, 2);
