...
Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::post('/contacts/consultarcuit', 'ContactController@consultar_cuit');

    Route::resource('categories', 'CategoryController');

    Route::resource('variation-templates', 'VariationTemplateController')->names('variation-templates');

    //products
    Route::post('/products/mass-deactivate', 'ProductController@massDeactivate')->name('products.massDeactivate');
    ...
    Route::post('/products/mass-delete', 'ProductController@massDestroy')->name('products.massDestroy');
    ...
    Route::get('/labels/add-product-row', 'LabelsController@addProductRow')->name('labels.addProductRow');
    Route::post('/labels/preview', 'LabelsController@preview')->name('labels.preview');
    ...
    Route::get('/reports/iva-report', 'ReportController@iva_report_txt');
    Route::get('/reports/iva-report_nc', 'ReportController@nc_report_txt');
    ...
    Route::put('/business-locations/{id}', 'BusinessLocationController@updateTaxConfig')->name('business_locations.update');
    ...
    Route::post('/store_cash_register_return', 'CashRegisterController@store_cash_register_return');
    Route::get('/cash-register/create_cash_register_return', 'CashRegisterController@create_cash_register_return');
    ...
    Route::resource('agent-temporal-stock', 'AgentTemporalStockController');
    Route::get('/temporal-stock-create-return', 'AgentTemporalStockController@createReturn')->name('temporalstock.return.create');
    Route::post('/temporal-stock-store-return', 'AgentTemporalStockController@storeReturn')->name('temporalstock.return.store');
    Route::get('/agent-stock-returns', 'AgentTemporalStockController@indexReturn')->name('temporalstock.return.index');
    Route::get('/agent-stock-return/{return_number}', 'AgentTemporalStockController@showReturn')->name('temporalstock.return.show');
    Route::get('/agent-stock-print-return/{return_number}', 'AgentTemporalStockController@printReturn')->name('temporalstock.print_return');
    ...
    // Sales Comission Agent Module
    Route::resource('delivery', 'DeliveryController');
    Route::get('delivery/add-return/{id}', 'DeliveryController@addReturn');
    Route::get('delivery/print/{id}', 'DeliveryController@printDeliveryReceipt')->name('delivery.printDeliveryReceipt');

    //Import opening stock
    Route::get('/import-opening-stock', 'ImportOpeningStockController@index');
    Route::post('/import-opening-stock/store', 'ImportOpeningStockController@store')->name('ImportOpeningStockController.store');
