...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Validator::extend('no_empty_spaces', function ($attribute, $value, $parameters, $validator) {
            return !is_string($value) || trim($value) !== '';
        }, 'El campo :attribute no debe contener solo espacios en blanco.');
    
        Validator::replacer('no_empty_spaces', function ($message, $attribute, $rule, $parameters) {
