...
class CashRegisterController extends Controller
{
     ...
     * @return void
     */
    public function __construct(CashRegisterUtil $cashRegisterUtil,BusinessUtil $businessUtil)
    {
    ...
    public function create_cash_register_return()
    {
        //Check if there is a open register, if yes then redirect to POS screen.
        if ($this->cashRegisterUtil->countOpenedRegister() != 0) {
            return redirect()->action('SellPosController@create');
        ...
        return view('cash_register.create_cash_register_return');
    }
    ...
    public function store_cash_register_return(Request $request)
    {
        try {
            $initial_amount = 0;
            if (!empty($request->input('amount'))) {
        ...
        return redirect()->action('SellPosController@index');
    }
    ...
    public function show($id)
    {
        ...
        //Log::emergency($register_details);
        return view('cash_register.register_details')
                    ->with(compact('register_details', 'details', 'pos_settings'));
    }
