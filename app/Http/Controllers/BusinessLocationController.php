...
class BusinessLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only([
                ...
                'invoice_layout_id', 'mobile', 'alternate_number', 'email', 'cuit', 'punto_venta', 'tax_label_1', 'tax_label_2', 'tax_number_2', 'afip_start_date', 'website', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'location_id'
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only([
                'name', 'razon_social', 'landmark', 'city', 'state', 'country', 'zip_code', 'invoice_scheme_id',
                'invoice_layout_id', 'mobile', 'alternate_number', 'email', 'website', 'cuit', 'punto_venta', 'tax_label_1', 'tax_label_2', 'tax_number_2', 'afip_start_date', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'location_id'
            ]);
