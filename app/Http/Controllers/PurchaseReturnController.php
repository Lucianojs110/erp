    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($purchase->purchase_lines as $purchase_line) {
                ...
                $product = Product::with('product_tax')->find($purchase_line->product_id);
                ...
                $productTaxId = optional($product->product_tax)->id;

                switch ($productTaxId) {
                    case 1:
                        $iva21 += $purchase_line->purchase_price * $purchase_line->quantity_returned;
                        break;
                    case 2:
                        $iva10 += $purchase_line->purchase_price * $purchase_line->quantity_returned;
                        break;
                    default:
                        // Acciones si no se encuentra un tax_id específico
                        break;
                }
