        ...
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    <td>Pagar:</td>
                    <td>
                        {!! Form::text('shortcuts[pos][finalize_pay_express]', !empty($shortcuts["pos"]["finalize_pay_express"]) ? $shortcuts["pos"]["finalize_pay_express"] : null, ['class' => 'form-control']); !!}
                    </td>
                </tr>
                <tr>
                    <td>Pagar con tarjeta:</td>
                    <td>
                        {!! Form::text('shortcuts[pos][express_finalize]', !empty($shortcuts["pos"]["express_finalize"]) ? $shortcuts["pos"]["express_finalize"] : null, ['class' => 'form-control']); !!}
                    </td>
                </tr>
        ...
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    <td>Pago multiple:</td>
                    <td>
                        {!! Form::text('shortcuts[pos][pago_multiple]', !empty($shortcuts["pos"]["pago_multiple"]) ? $shortcuts["pos"]["pago_multiple"] : null, ['class' => 'form-control']); !!}
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <br>
                  <label>
                    ...
                    [ 'class' => 'input-icheck']); !!} Personal de Servicio
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[pagos_monedas]', 1,  
                    empty($pos_settings['pagos_monedas']) ? 0 : 1 , 
                    [ 'class' => 'input-icheck']); !!} Habilitar pagos monedas extranjeras
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[check_afip]', 1,  
                    empty($pos_settings['check_afip']) ? 0 : 1 , 
                    [ 'class' => 'input-icheck']); !!} Facturar por defecto
                  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[modal_cambio]', 1,  
                    empty($pos_settings['modal_cambio']) ? 0 : 1 , 
                    [ 'class' => 'input-icheck']); !!} Mostar Modal Cambio
                  </label>
                </div>
            </div>
        </div>
