          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select('tipo_doc', [
                ...
                'Doc Otro' => 'Doc Otro'
                ], $contact->tipo_doc , ['class' => 'form-control pull-left','placeholder' => __('messages.please_select')]); !!}
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::select('iva', ['RESPONSABLE INSCRIPTO' => 'RESPONSABLE INSCRIPTO', 'CONSUMIDOR FINAL' => 'CONSUMIDOR FINAL', 'MONOTRIBUTO' => 'MONOTRIBUTO', 'EXENTO' => 'EXENTO'], $contact->iva, ['class' => 'form-control pull-left','placeholder' => __('messages.please_select')]); !!}
