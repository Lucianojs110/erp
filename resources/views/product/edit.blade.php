        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <br>
                        {!! Form::checkbox('hasMayorista', 1, $product->hasMayorista, ['class' => 'input-icheck']) !!} <strong>¿Diferenciar precio Mayorista?</strong>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            /**
             * Escribe números respetando el formato configurado
             * en el sistema.
             */
            ...
            /**
             * Ejecuta el cálculo original de product.js.
             *
             * Esto actualiza:
             * - Precio de compra con impuestos.
            ...
            /**
             * Convierte el precio base USD a ARS.
             */
            function calculatePurchasePriceFromUsd() {
                var $checkbox = $('#purchase_price_in_usd');
                ...
                /*
                 * Espera a que el valor haya sido escrito antes
                 * de ejecutar los eventos originales.
                 */
                setTimeout(function() {
            ...
            function toggleUsdPurchaseMode(enabled) {
                ...
                /*
                 * Muestra u oculta precio USD y cotización.
                 */
                ...
                /*
                 * Si está desactivado, el input USD no se envía
                 * al backend.
                 */
                $usdInput
                ...
                /*
                 * En modo USD, los precios de compra en ARS
                 * son automáticos.
                 *
                 * En modo tradicional vuelven a ser editables.
                 */
                $purchasePrice.prop(
                    'readonly',
                    enabled
            ...
            /**
             * Respaldo en caso de que iCheck no esté inicializado.
             */
            $(document).on(
                'change',
                '#purchase_price_in_usd',
            ...
            /**
             * Recalcula cuando cambia el precio base USD.
             */
            $(document).on(
                'input keyup change',
                '#single_dpp_usd',
            ...
            /**
             * Recalcula el precio de venta cuando cambia
            ...
            if (productFormContainer) {
                var observer = new MutationObserver(
                    function() {
                        ...
                        /*
                         * Inicializa el formulario respetando
                         * el estado guardado del producto.
                         */
                        toggleUsdPurchaseMode(
                            $checkbox.is(':checked')
                        );
