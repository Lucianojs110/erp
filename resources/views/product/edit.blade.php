  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="form-group">
        ...
        <label>
        </label>@show_tooltip('Habilita o deshabilita la opcion de tener precio mayorista.') <p class="help-block"><i>Habilitar el cambio de precio para este producto a partir de cierta cantidad vendida</i></p>
      </div>
    </div>
