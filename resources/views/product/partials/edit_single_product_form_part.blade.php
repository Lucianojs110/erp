  ...
  <div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
      ...
      <tr>
        ...
        <td>
          <br />
          {!! Form::text('cantidadMayorista', @num_format($variation->cantidadMayorista), ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
        </td>
        <td>
          <br />
          {!! Form::text('precioMayorista', @num_format($variation->precioMayorista), ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
        </td>
