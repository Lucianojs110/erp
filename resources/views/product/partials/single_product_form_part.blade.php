  ...
  <div class="table-responsive">
    <table class="table table-bordered add-product-price-table table-condensed {{$class}}">
        ...
        <tr>
          ...
          <td>
          <br/>
            {!! Form::text('cantidadMayorista', $default, ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
          </td>
          <td>
          <br/>
            {!! Form::text('precioMayorista', $default, ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
          </td>
        </tr>
    </table>
    </div>
