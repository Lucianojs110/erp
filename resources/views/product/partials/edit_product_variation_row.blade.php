        ...
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][cantidadMayorista]', @num_format($variation->cantidadMayorista), ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
                    </td>
                    <td>
                        {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][precioMayorista]', @num_format($variation->precioMayorista), ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
                    </td>
                    <td>
