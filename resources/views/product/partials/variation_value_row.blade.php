...
<tr>
    ...
    <td>
    {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][cantidadMayorista]', $default, ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
    </td>
    <td>
    {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][precioMayorista]',  $default, ['class' => 'form-control input-sm dsp input_number', 'id' => '', ]); !!}
    </td>
    <td>
