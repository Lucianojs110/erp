...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('filtro_factura', ['A' => 'A', 'B' => 'B', 'C' => 'C', null => 'Todos'], null, [
            'class' => 'form-control',
        ]) !!}
    </div>
</div>
...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('sell_list_filter_cr_user', $users, null, [
            'class' => 'form-control select2',
            'style' => 'width:100%',
            'placeholder' => __('lang_v1.all'),
        ]) !!}
...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('sell_list_filter_cash_register_id', $cash_registers, null, [
            'class' => 'form-control select2',
            'style' => 'width:100%',
            'placeholder' => __('lang_v1.all'),
        ]) !!}
