        ...
        <div class="row">
            <div class="@if (!empty($pos_settings['hide_product_suggestion']) && !empty($pos_settings['hide_recent_trans'])) col-md-10 col-md-offset-1 @else col-md-7 @endif col-sm-12">
                @component('components.widget', ['class' => 'box-success'])
                    ...
                    <input type="hidden" name="pos_token" id="pos_token" value="">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="iva" id="iva" value="{{ $walk_in_customer['iva'] }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12 pos_product_div" id="pos_product_list">
