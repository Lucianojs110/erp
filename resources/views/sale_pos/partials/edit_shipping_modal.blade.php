				...
				<div class="row">
					<div class="col-md-6">
				        <div class="form-group">
				            {!! Form::label('shipping_details_modal', 'Detalle de cargo' . ':*' ) !!}
				            {!! Form::textarea('shipping_details_modal',$shipping_details, ['class' => 'form-control','placeholder' => 'Detalle de cargo', 'required' ,'rows' => '4']); !!}
				        </div>
				    </div>

				    <div class="col-md-6">
				        <div class="form-group">
				            {!! Form::label('shipping_charges_modal', 'Costo' . ':*' ) !!}
