...
<script type="text/javascript">
	$(document).ready( function() {
		...
		@if(!empty($shortcuts["pos"]["express_finalize"]))
			Mousetrap.bind('{{$shortcuts["pos"]["express_finalize"]}}', function(e) {
				e.preventDefault();
				$('button.pos-express-finalize[data-pay_method="card"]').trigger('click');
			});
		@endif

		@if(!empty($shortcuts["pos"]["finalize_pay_express"]) )
			Mousetrap.bind('{{$shortcuts["pos"]["finalize_pay_express"]}}', function(e) {
				e.preventDefault();
				$('button.pos-express-finalize-pay').trigger('click');
			});
		@endif

		@if(!empty($shortcuts["pos"]["pago_multiple"]) )
			Mousetrap.bind('{{$shortcuts["pos"]["pago_multiple"]}}', function(e) {
				e.preventDefault();
				$('button.pago_multiple').trigger('click');
			});
		@endif
