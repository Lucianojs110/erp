...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            {!! Form::hidden('payment[0][method_card]', '', [
                'class' => 'form-control ',
                'required',
                'id' => 'method_card_0',
                'style',
            ...
            <div class="modal-footer">
                <button type="button" data-pay_method="card" class="btn btn-primary"
...
<!-- Used for express checkout cheque transaction -->
<div class="modal fade" tabindex="-1" role="dialog" id="cheque_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">@lang('lang_v1.cheque_transaction_details')</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.cheque_number'),
                                    'id' => 'cheque_number',
                                    'autofocus',
                                ]) !!}
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.cheque_bank_name'),
                                    'id' => 'cheque_bank',
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::date('', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.cheque_issue_date_hold'),
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('cheque_deferral_date', __('lang_v1.cheque_deferral_date')) !!}
                                {!! Form::date('', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.cheque_deferral_date_hold'),
                                    'id' => 'cheque_deferral_date',
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mr-2">
                                {!! Form::label('cheque_type', __('lang_v1.cheque_type')) !!}
                                {!! Form::select('cheque_type',
                                    ['comun' => 'Comun', 'diferido' => 'Diferido', 'electronico' => 'Electronico'],'comun',
                                    ['class' => 'form-control select2', 'id' => 'cheque_type'],
                                ) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('cheque_amount', __('lang_v1.cheque_amount')) !!}
                                {!! Form::text('', null, [
                                    'class' => 'form-control',
                                    'placeholder' => __('lang_v1.cheque_amount_hold'),
                                    'id' => 'cheque_amount',
                                ]) !!}
                            </div>
                        </div>
            ...
            {!! Form::hidden('payment[0][method_cheque]', '', [
                'class' => 'form-control ',
                'required',
                'id' => 'method_cheque_0',
                'style',
            ...
            <div class="modal-footer">
                <button type="button" data-pay_method="cheque" class="btn btn-primary"
                    id="pos-save-cheque">@lang('sale.finalize_payment')</button>
            </div>
