...
<div class="payment_details_div @if ($payment_line['method'] !== 'cheque') {{ 'hide' }} @endif" data-type="cheque">
    ...
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label("cheque_bank_$row_index", __('lang_v1.cheque_bank')) !!}
            {!! Form::text("payment[$row_index][cheque_bank]", $payment_line['cheque_bank'], [
                'class' => 'form-control',
                'placeholder' => __('lang_v1.cheque_bank'),
                'id' => "cheque_bank_$row_index",
            ]) !!}
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label("cheque_type_$row_index", __('lang_v1.cheque_type')) !!}
            {!! Form::select(
                "payment[$row_index][cheque_type]",
                ['comun' => 'Comun', 'diferido' => 'Diferido', 'electronico' => 'Electronico'],
                $payment_line['cheque_type'],
                [
                    'class' => 'form-control',
                    'placeholder' => __('lang_v1.cheque_type'),
                    'id' => "cheque_type_$row_index",
                ],
            ) !!}
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            {!! Form::date("payment[$row_index][cheque_issue_date]", $payment_line['cheque_issue_date'], [
                'class' => 'form-control',
                'placeholder' => __('lang_v1.cheque_issue_date'),
                'id' => "cheque_issue_date_$row_index",
            ]) !!}
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label("cheque_deferral_date_$row_index", __('lang_v1.cheque_deferral_date')) !!}
            {!! Form::date("payment[$row_index][cheque_deferral_date]", $payment_line['cheque_deferral_date'], [
                'class' => 'form-control',
                'placeholder' => __('lang_v1.cheque_deferral_date'),
                'id' => "cheque_deferral_date_$row_index",
            ]) !!}
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::label("cheque_amount_$row_index", __('lang_v1.cheque_amount')) !!}
            {!! Form::text("payment[$row_index][cheque_amount]", $payment_line['cheque_amount'], [
                'class' => 'form-control',
                'placeholder' => __('lang_v1.cheque_amount'),
                'id' => "cheque_amount_$row_index",
            ]) !!}
        </div>
    </div>
    <div class="clearfix"></div>
