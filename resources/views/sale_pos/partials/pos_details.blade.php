							...
							<td>
								...
								<div class="col-sm-2 col-xs-6 d-inline-table">
									...
									<span class="@if($pos_settings['disable_discount'] != 0) hide @endif">
										...
										<b>Cargos(+): @show_tooltip(__('tooltip.shipping'))</b>
										<br/>
										<i class="fa fa-pencil-square-o cursor-pointer" title="Cargos" aria-hidden="true" data-toggle="modal" data-target="#posShippingModal"></i>
								...
								<input type="hidden"  id="modal_cambio" value={{$pos_settings['modal_cambio']}}>

								@if(auth()->user()->can('sell.payments'))
							
									<div class="col-sm-1 col-xs-12 d-inline-table">

										@if($pos_settings['check_afip']=='1')
											<div class="form-check">
												<input class="form-check-input" type="checkbox" name="registrar" checked id="registrar" style="width:30px; height:30px;">
										...
										@else
											<div class="form-check">
												<input class="form-check-input" type="checkbox" name="registrar"  id="registrar" style="width:30px; height:30px;">
												<label class="form-check-label">
													Registrar
												</label>
											</div>
						...
						<tr>
							<td>
								...
								<div class="col-sm-3 col-xs-6 col-2px-padding">
									...
									<button type="button" id="pos-suspend" class="btn bg-red btn-block btn-flat no-print pos-suspend" data-pay_method="suspend" title="@lang('lang_v1.tooltip_suspend')">
										<div class="text-center">
											<i class="fa fa-check" aria-hidden="true"></i>
								...
								<div class="col-sm-4 col-xs-12 col-2px-padding">
									<button type="button" class="btn bg-navy  btn-block btn-flat btn-lg no-print @if($pos_settings['disable_pay_checkout'] != 0) hide @endif pos-express-btn pago_multiple" id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')">
										<div class="text-center">
											<i class="fa fa-check" aria-hidden="true"></i>
