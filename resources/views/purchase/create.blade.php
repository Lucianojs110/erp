		...
		<div class="row">
			...
			<table class="table">
				...
				<tr>
					...
					<!-- Primer td para seleccionar tipo (percepción o retención) -->
					<td>
						<div class="form-group">
							{!! Form::label('selected_withholding_type', 'Seleccionar Categoria:') !!}
					...
					<!-- Segundo td para mostrar el select múltiple -->
					<td id="withholding-options-td" style="display: none;">
						<div class="form-group">
				...
				<tr>
					...
					<td>
						...
						{!! Form::hidden('iva21', 0 , ['id' => 'iva21']); !!}
						{!! Form::hidden('iva10', 0 , ['id' => 'iva10']); !!}
