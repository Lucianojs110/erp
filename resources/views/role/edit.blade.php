  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'stock_transfers.permitted_locations', in_array('stock_transfers.permitted_locations', $role_permissions),['class' => 'input-icheck']); !!}
            Permitir tranferencias de stock a todas las ubicaciones
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} Ver/cerrar Cajas
          </label>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} {{ "Ver repartos" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} {{ "Agregar repartos" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'delivery.edit', in_array('delivery.edit', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Editar repartos" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            ...
            [ 'class' => 'input-icheck']); !!} {{ "Borrar repartos" }}
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'agent.view', in_array('agent.view', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Ver agentes" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'agent.create', in_array('agent.create', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Agregar agentes" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'agent.edit', in_array('agent.edit', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Editar agentes" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'agent.delete', in_array('agent.delete', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Remover agentes" }}
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'return.view', in_array('return.view', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Ver devoluciones" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'return.create', in_array('return.create', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Agregar devoluciones" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'return.edit', in_array('return.edit', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Editar devoluciones" }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'return.delete', in_array('return.delete', $role_permissions),
            [ 'class' => 'input-icheck']); !!} {{ "Borrar devoluciones" }}
          </label>
        </div>
      </div>
    </div>
