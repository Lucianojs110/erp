    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('name', 'Razon Social'. ':*') !!}
                        {!! Form::text('razon_social', null, ['class' => 'form-control', 'required', 'placeholder' => __(
                        'Razon Social' ) ]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('Cuit') !!}
                        {!! Form::text('cuit', null, ['class' => 'form-control', 'placeholder' => 'Ingrese cuit']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('tax_label_2', null, ['class' => 'form-control', 'placeholder' => 'Nombre
                        impuesto 2']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('tax_number_2', null, ['class' => 'form-control', 'placeholder' => 'Numero
                        Impuesto 2']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('punto_venta', null, ['class' => 'form-control', 'placeholder' => 'punto de
                        venta']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('Fecha inicio actividades afip') !!}
                        <div class="input-group">
                            <input type="date" id="start" class="form-control" name="afip_start_date" value="2022-01-22"
