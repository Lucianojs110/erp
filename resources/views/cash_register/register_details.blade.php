        ...
        <div class="col-sm-12">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->guarani }}</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->reales }}</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->dolar }}</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->euro }}</span>
              </td>
            </tr>
            @endif
            <tr>
            ...
            <tr class="success">
              ...
              <td>
                ...
                @if($register_details->total_cash_refund != 0)
                  Efectivo: <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cash_refund }}</span><br>
                @endif
                ...
                @if($register_details->total_card_refund != 0) 
                  Tarjeta: <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_card_refund }}</span><br> 
                @endif
                @if($register_details->total_bank_transfer_refund != 0)
                  Transferencia Bancaria: <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_bank_transfer_refund }}</span><br>
                @endif
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_expense }}</span></b><br>
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash - $register_details->total_cash_refund - $register_details->total_expense}}</span></b>
              </td>
            </tr>
          </table>
        </div>
