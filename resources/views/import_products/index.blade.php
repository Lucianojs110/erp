        ...
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>30</td>
                        <td>@lang('lang_v1.variation_card_group') <small class="text-muted">(@lang('lang_v1.optional'), @lang('lang_v1.default'): TARJETA)</small></td>
                        <td>{!! __('lang_v1.variation_card_group_help_text') !!}</td>
                        </td>
                    </tr>
                    <tr>
                        <td>31</td>
                        <td>@lang('lang_v1.variation_card_price') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>{!! __('lang_v1.variation_card_price_help_text') !!}</td>
                    </tr>
                    <tr>
                        <td>32</td>
                        <td>@lang('lang_v1.variation_transfer_group') <small class="text-muted">(@lang('lang_v1.optional'), @lang('lang_v1.default'): CREDITO)</small></td>
                        <td>{!! __('lang_v1.variation_transfer_group_help_text') !!}</td>
                    </tr>
                    <tr>
                        <td>33</td>
                        <td>@lang('lang_v1.variation_transfer_price') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>{!! __('lang_v1.variation_transfer_price_help_text') !!}</td>
                    </tr>
                    <tr>
                        <td>34</td>
