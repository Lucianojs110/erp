    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button"
                class="btn btn-info btn-flat pull-left m-8 hidden-xs btn-sm mt-10 popover-default" data-toggle="popover"
            ...
            {{-- Botón de cotización USD --}}
            <button type="button" id="btnUsdExchangeRate" title="Cotización del dólar" data-toggle="modal"
                data-target="#usdExchangeRateModal" class="btn btn-info btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
                <strong>
            ...
            @if ($request->segment(1) == 'pos')
                <button type="button" id="register_details" title="{{ __('cash_register.register_details') }}"
                    ...
                    class="btn btn-info btn-flat pull-left m-8 hidden-xs btn-sm mt-10 btn-modal"
            ...
            @can('sell.create')
                <a href="{{ action('SellPosController@create') }}" title="POS" data-toggle="tooltip"
                    data-placement="bottom" class="btn btn-info btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
