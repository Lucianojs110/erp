...
<section class="content">
    ...
    <div class="row">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <div class="col-md-12">
                <div class="form-group">
                  @if(!$is_sales_commission_agent)
                    {!! Form::label('role', __( 'user.role' ) . ':*') !!}
                    {!! Form::select('role', $roles, $user->roles->first()->id, ['class' => 'form-control select2']); !!}
                  @else
                    {!! Form::label('role', __( 'user.role' ) . ':*') !!}
                    {!! Form::select('role', $roles, $user->roles->first()->id, ['class' => 'form-control select2', 'disabled']); !!}
                  @endif
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="form-group">
                  {!! Form::label('cmmsn_percent', __( 'lang_v1.cmmsn_percent' ) . ':') !!} @show_tooltip(__('lang_v1.commsn_percent_help'))
                    {!! Form::number('cmmsn_percent', ($cmmsn_percent*100), ['class' => 'form-control', 'placeholder' => __( 'lang_v1.cmmsn_percent' ), 'step' => 0.01, 'min' => 0, 'max' => 100]); !!}
                </div>
            </div>
