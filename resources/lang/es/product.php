...
return [
    ...
    'weight_per_package' => 'Peso por bulto (kg)',
    'weight_per_package_placeholder' => 'Ingrese el peso por bulto en kg',
    'manages_packages' => 'Maneja bultos',
    'manages_packages_help' => 'Usa el campo peso como peso teórico de un bulto.',
    'weight_per_package_required' => 'Debes ingresar un peso por bulto mayor que cero.',
    'package' => 'piezas',
    'packages' => 'piezas',
    'pieces' => 'Piezas',
    'weight_kg' => 'Peso (kg)',
